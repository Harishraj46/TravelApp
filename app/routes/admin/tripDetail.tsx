...
const tripDetail = ({loaderData}:Route.ComponentProps) => {
    ...
    const{name,duration,itinerary,travelStyle,groupType,budget,interests,
          estimatedPrice,description,bestTimeToVisit,weatherInfo,country
    }=tripData || {}  
  ...
  return (
    <main className="travel-detail wrapper"> 
       <Header title="Trip Details" description="View and Edit AI generated Trip Plans"/>
       ...
       <section className="container wrapper-md">
        ...
        />
           ...
           <p className="text-sm md:text-lg font-normal text-black-400">{description}</p>
           ...
           <ul className="itinerary">
                ...
                <div className="trip-grid">
                    {allTrips.map(({id,name,imageUrl,itinerary,location,interests,travelStyle,estimatedPrice}) => (
